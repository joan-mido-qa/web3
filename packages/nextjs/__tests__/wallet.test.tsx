...
describe("Wallet", () => {
  ...
  describe("Deploy Contract", () => {
    ...
    test("Should deploy Conntract and return Address", async () => {
      ...
      const contract = new File([file], "HelloWorld.json", { type: "application/json" });
    ...
    test("Should expect a Contract file containing the ABI and Bytecode", async () => {
      ...
      const contract = new File(["{}"], "Invalid.json", { type: "application/json" });
    ...
    test("Should expect a JSON file", async () => {
      ...
      const contract = new File(["invalid"], "Invalid.txt", { type: "plain/text" });
